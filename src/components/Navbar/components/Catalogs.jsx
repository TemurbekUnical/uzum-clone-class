                        ...
                        <TabContext value={value}>
                            <div className='headerBox container'>
                                ...
                                <div className='infoBox'>
                                    ...
                                    <TabPanel value="4"><h3>Pyabzallar</h3></TabPanel>
                                    <TabPanel value="5"><h3>Aksessuarlar</h3></TabPanel>
                                    <TabPanel value="6"><h3>Go'zallik</h3></TabPanel>
                                    <TabPanel value="7"><h3>Salomatlik</h3></TabPanel>
                                    <TabPanel value="8"><h3>Uy-ro'zg'or</h3></TabPanel>
                                    <TabPanel value="9"><h3>Qurilish ta'mirlash</h3></TabPanel>
