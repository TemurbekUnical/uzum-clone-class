...
const SotibOlish = () => {
  const {
    state: { mahsulotlarsoni, obshiySumma, tanlanganMahsulotlar },
    action: { onPlusClick, onMinusClick, mahsulotniSavatchadanChiqarish },
                    ...
                    <div className="m-malumot">
                      ...
                      <div className="m-mahsulot">
                        <div className="m-sotuvchi">
                          <p className="stv-p">Satuvchi: </p>{" "}
                          <p>{mahsulot.sotuvchi}</p>
                        </div>
